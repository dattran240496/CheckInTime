...
//        let tapGesture = UITapGestureRecognizer(target: self, action: #selector(MemberController.imgTapped(_:)))
//        tapGesture.numberOfTapsRequired = 1
//        tapGesture.numberOfTouchesRequired = 1
//        cell.imgAvatar.isUserInteractionEnabled = true
//        cell.imgAvatar.addGestureRecognizer(tapGesture)
        return cell
    }
